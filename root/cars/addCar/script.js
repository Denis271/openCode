...
function checkStateNumber(){ //проверка номера прав
...
function checkYear(){ //проверка номера прав
...
function checkChassisNumber(){ //проверка номера прав
...
function checkBodyNumber(){ //проверка номера прав
...
function checkСategories(){ //проверка номера прав
...
function ajaxGet(){
    ...
    console.log('data.php?stateNumber=' + stateNumber + '&year=' + year + '&chassisNumber=' + chassisNumber + '&bodyNumber=' + bodyNumber + '&category=' + category)
    ...
    let urlAjaX = 'data.php?stateNumber=' + stateNumber + '&year=' + year + '&chassisNumber=' + chassisNumber + '&bodyNumber=' + bodyNumber + '&category=' + category
